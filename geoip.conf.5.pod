...
If you need to match on city names containing non L<ascii(7)> charachters
...
a country code (uppercased, two charachers), C<*> or C<UNKNOWN>

=item *

a country code like above and C<,> and a city name (or C<*>) 
