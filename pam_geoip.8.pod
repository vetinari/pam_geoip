...
B<Note> that I<pam> just receives a hostname. When trying to find an IP for
this name the modules tries IPv4 first, then IPv6.
...
This must be a "GeoIP City Edition IPv6" file, see
L<http://www.maxmind.com/app/city> and / or
L<http://www.maxmind.com/app/geolitecity> for more information.
